...
module.exports = class{
	...
	set(_var,_val){
		if(typeof _var=="undefined"||typeof _val=="undefined"){return false;}
	...
	request(_URL,_Data,_Method,_RequestHeaders,isUser,_Request){
		if(typeof _URL=="undefined"){_URL="/";}
		if(typeof _Data=="undefined"){_Data={};}
		if(typeof _Method=="undefined"){_Method="GET";}
		if(typeof _RequestHeaders=="undefined"){_RequestHeaders={};}
		if(typeof isUser!=="boolean"){isUser=true;}
		if(typeof _Request=="undefined"){_Request={};}
		let _Response = {};
	...
	start(){
		...
		this.runningServer[0].listen(this.config.port,this.config.host);
		let ports = [this.config.port];
		if(typeof this.runningServer[1]!=="undefined"){
			this.runningServer[1].listen(this.config.https_port,this.config.port);
